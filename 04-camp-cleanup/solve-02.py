...
with open(in_file_name) as camp_section_file:
    ...
    for assignment in camp_section_file:
        ...
        if (elf1_upper_section >= elf2_lower_section or elf2_upper_section <= elf1_lower_section) and not (elf1_lower_section > elf2_upper_section or elf2_lower_section > elf1_upper_section):
